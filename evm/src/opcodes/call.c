...
static evm_status_t op_callcode(evm_t *evm)
{
    ...
    if (args_size_u64 > 0)
    {
        ...
        if (!call_args)
        {
            LOG_EVM_DEBUG("CALLCODE: Failed to allocate call arguments");
            return EVM_INTERNAL_ERROR;
        }
...
static evm_status_t op_delegatecall(evm_t *evm)
{
    ...
    if (args_size_u64 > 0)
    {
        ...
        if (!call_args)
        {
            LOG_EVM_DEBUG("DELEGATECALL: Failed to allocate call arguments");
            return EVM_INTERNAL_ERROR;
        }
...
static evm_status_t op_staticcall(evm_t *evm)
{
    ...
    if (args_size_u64 > 0)
    {
        ...
        if (!call_args)
        {
            LOG_EVM_DEBUG("STATICCALL: Failed to allocate call arguments");
            return EVM_INTERNAL_ERROR;
        }
