 ...
 *
 * Usage:
 *   ./test_data_art_txn_stress <seconds> [key_size]
...
#define TEST_DIR "/tmp/test_data_art_txn_stress"
 ...
 */
static void run_txn_stress_test(int duration_seconds, unsigned int base_seed, size_t key_size) {
    // Validate key size
...
int main(int argc, char *argv[]) {
    ...
    run_txn_stress_test(duration, base_seed, key_size);
    return 0;
}
