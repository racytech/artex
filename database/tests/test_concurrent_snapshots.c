...
void test_concurrent_readers(void) {
    ...
    const char *dir = "/tmp/test_concurrent_readers";
    ...
    // Cleanup
    system("rm -rf /tmp/test_concurrent_readers");
}
...
void test_concurrent_readers_writers(void) {
    ...
    const char *dir = "/tmp/test_concurrent_rw";
    data_art_tree_t *tree = create_test_tree(dir);
    initialize_data(tree);
    ...
    // Cleanup
    system("rm -rf /tmp/test_concurrent_rw");
}
...
void test_stress_concurrent(void) {
    ...
    const char *dir = "/tmp/test_stress";
    data_art_tree_t *tree = create_test_tree(dir);
    initialize_data(tree);
